...
docker container run --network-alias local_network_zoom_server --network local_network -it -v /home/razvan/Workspace/Image-editor-in-cloud-docker/Images/:/home/Images/ zoom-server java -jar /home/ZoomServer.jar
docker container run --network local_network -d -v /home/razvan/Workspace/Image-editor-in-cloud-docker/Images/:/home/Images/ client-simulation java -jar /home/ClientSimulation.jar
